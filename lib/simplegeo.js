...
var SimpleGeo = exports.SimpleGeo = function(key,secret,customHeaders) {
    ...
    if (key && secret) {
        ...
        oauth = new OAuth('','',key,secret,'1.0',null,'HMAC-SHA1',customHeaders);
    }
    ...
    this.secure_call = function (version,path,method,callback,obj) {
        ...
        console.warn('client endpoint: ', resource)
 ...
 */
SimpleGeo.prototype.getNearbyPlacesByLatLng = function (lat, lng, callback) {
  this.getNearbyPlaces(SimpleGeo.LATLNG, [lat,lng], callback)
}

SimpleGeo.prototype.getNearbyPlacesByAddress = function (address, callback) {
  this.getNearbyPlaces(SimpleGeo.ADDRESS, address, callback)
}

SimpleGeo.prototype.getNearbyPlacesByIp = function (ip, callback) {
  this.getNearbyPlaces(SimpleGeo.IP, ip, callback)
}
